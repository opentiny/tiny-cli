...
export default {
	zh: {
		// handle-default.js
		intranetTips:
			'运行报错, 请在issue中反馈问题：https://open.codehub.huawei.com/innersource/TinyStage/aio/issues/new',
...
`,
	...
	en: {
		// handle-default.js
		intranetTips:
			'Runtime Error, please report the issue: https://open.codehub.huawei.com/innersource/TinyStage/aio/issues/new',
