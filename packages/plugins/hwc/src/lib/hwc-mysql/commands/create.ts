...
import {
  createSecurityGroupRulesForRDS,
  deleteSecurityGroupRule,
  getSecurityGroupId,
  getSecurityGroupRules,
  setPortToSecurityGroupRules,
} from '../../hwc-vpc/services/security-groups-service';
...
async function buyAndSyncInstances(ans) {
