export default {
  ...
  'menu.cloud.validateError': 'Verification failed!',
  'menu.cloud.createSuccess': 'Create Contract Success',
  'menu.cloud.editSuccess': 'Create Contract Success',
  'menu.cloud.deleteSuccess': 'Delete Contract Success',
