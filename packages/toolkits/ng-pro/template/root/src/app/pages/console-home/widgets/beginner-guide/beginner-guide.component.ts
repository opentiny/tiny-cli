...
export class BeginnerGuideComponent {
  ...
  public guideList: Array<BeginnerItem> = [
    ...
    {
      href: `${SupportUrlPrefix}bestpractice-website/zh-cn_topic_0089383096.html`,
      text: `${TurorialI18nPrefix}websiteTutorial`,
    },
    {
      href: `${SupportUrlPrefix}qs-obs/obs_qs_0001.html`,
      text: `${TurorialI18nPrefix}uploadTutorial`,
    },
  ];
}
