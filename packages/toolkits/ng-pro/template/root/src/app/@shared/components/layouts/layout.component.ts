...
@Component({
  ...
  template: `
    <ul class="t-pro-sidebar-tools-list">
      <li class="t-pro-sidebar-tools-item" (click)="sidebarShrink(!isSidebarShrink)">
        <ng-container *ngIf="isSidebarShrink">
          <ti-icon local name="angle-right"></ti-icon>
        </ng-container>
      </li>
    </ul>
  `,
