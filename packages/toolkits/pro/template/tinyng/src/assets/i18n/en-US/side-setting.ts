export default {
  'side-setting': {
    ...
    'desc-sidebar': 'Fixed sidebar',
    'desc-header': 'Fixed head',
    'desc-header-sidebar': 'Fixed head、sidebar',
    'free-area': 'Customized configuration',
    ...
    'copy-content':
      'Please modify config file in src/app/@shared/layouts/t-pro-layout/default-layout.config.ts',
    'sidebar-notice': {
