...
import { TProLayoutConfig, TProLayoutService, TProBaseScreenMediaQueryService, SIDEBAR_LAYOUT_CONFIG, SIZE } from '@shared/tiny-pro';
...
export class PagesComponent implements OnInit {
  ...
  sidebarShrink(isShrink: boolean) {
    ...
    if (this.layoutConfig.sidebar.firSidebar) {
      this.layoutConfig.sidebar.firSidebar.width = this.isSidebarShrink ? SIZE.CLOSE_WIDTH : SIZE.OPEN_WIDTH;
    }
