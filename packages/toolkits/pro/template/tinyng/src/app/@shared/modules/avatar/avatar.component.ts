...
@Component({
  selector: 't-pro-base-avatar',
  changeDetection: ChangeDetectionStrategy.OnPush,
  templateUrl: './avatar.component.html',
  styleUrls: ['./avatar.component.scss'],
  preserveWhitespaces: false,
})
export class TProBaseAvatarComponent implements OnChanges, OnInit {
  isNobody = true;
  isErrorImg = false;
  /**
  * 自定义头像显示文字
 ...
 */
  ...
  calcValues(nameInput: string): void {
  ...
  setDisplayName(name: string, width: number): void {
    if (this.customText) {
  ...
  getBackgroundColor(char: string): void {
    if (this.gender) {
