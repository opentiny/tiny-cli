...
@Component({
  selector: 't-pro-base-back-top',
  templateUrl: './back-top.component.html',
  styleUrls: ['./back-top.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  preserveWhitespaces: false,
})
export class TProBaseBackTopComponent implements OnInit, OnChanges, OnDestroy {
  @Input() customTemplate: TemplateRef<any>;
  @Input() visibleHeight: number = 300;
  ...
  getScrollTarget() {
    if (this.scrollTarget) {
      this.el.nativeElement.querySelector('.t-pro-base-backtop').style.position = 'absolute';
