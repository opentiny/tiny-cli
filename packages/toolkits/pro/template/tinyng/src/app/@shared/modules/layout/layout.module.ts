...
@NgModule({
  declarations: [LayoutComponent, AsideComponent, ContentComponent, FooterBasicComponent, HeaderBasicComponent],
  imports: [CommonModule],
  exports: [LayoutComponent, AsideComponent, ContentComponent, FooterBasicComponent, HeaderBasicComponent],
})
